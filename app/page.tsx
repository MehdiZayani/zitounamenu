...
const menuData: MenuSection[] = [
  // PAGE 1 - PETIT DEJ
  {
    ...
    leftItems: [
      ...
      { title: "OEUF BROUILLÉ BRESAOLA", price: "22,900", description: "" },
      { title: "OEUF BROUILLÉ CHAMPIGNON", price: "21,900", description: "" },
      { title: "OEUF BROUILLÉ NATURE", price: "18,200", description: "" },
      { title: "OEUF BROUILLÉ POULET FUMÉ", price: "22,900", description: "" },
      { title: "OEUF BROUILLÉ SAUMON", price: "23,900", description: "" },
      { title: "LE SPORTIF", price: "18,900", description: "" }
    ],
    rightItems: []
  },
        ...
        >
          <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 8 }}>
            <button
              onClick={prev}
              aria-label="Previous"
              style={{ flexShrink: 0, padding: '10px 14px', background: 'rgba(255,255,255,0.1)', borderRadius: '50%', border: 'none', color: '#eedab7', cursor: 'pointer', fontSize: 18 }}
            >
              ◀
            </button>
            <div ref={navRef} className="no-scrollbar" style={{ overflowX: 'auto', whiteSpace: 'nowrap', display: 'flex', gap: 12, padding: '8px', flex: 1, alignItems: 'center' }}>
              {(source as MenuSection[]).map((s, i) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    flexShrink: 0,
                    background: i === index ? '#d4a574' : 'rgba(255,255,255,0.1)',
                    color: i === index ? 'black' : '#eedab7',
                    fontFamily: "'LaLuxes', serif",
                    fontSize: 15,
                    letterSpacing: '0.1em',
                    transition: 'all 0.2s',
                    boxShadow: i === index ? '0 2px 8px rgba(0,0,0,0.4)' : 'none'
                  }}
                >
                  {s.label}
                </button>
